...
const ABTestStats: React.FC = () => {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "A/B Test Statistics Dashboard",
    "description": "Real-time analytics and performance metrics for KarmaMap homepage variants and conversion tracking.",
    "url": "https://karmamap.lovable.app/ab-stats"
  };

  return (
    <>
      <SEO
        title="A/B Test Analytics Dashboard | KarmaMap™ Statistics"
        description="View real-time analytics and performance metrics for KarmaMap homepage variants. Track conversion rates and user engagement across different experiences."
        keywords="ab test, analytics, conversion tracking, performance metrics, dashboard"
        canonicalUrl="https://karmamap.lovable.app/ab-stats"
