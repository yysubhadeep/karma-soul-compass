        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-foreground/80 space-y-6">
            <section>
              ...
              <p>
                This Privacy Policy describes how EMBEDDED DISTRIBUTION TECHNOLOGY PRIVATE LIMITED and its affiliates (collectively "EMBEDDED DISTRIBUTION TECHNOLOGY PRIVATE LIMITED, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website https://mykarmamap.com/ (hereinafter referred to as Platform).
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">Collection</h2>
              <p>
              ...
              <p className="font-semibold">
                If you receive an email, a call from a person/association claiming to be EMBEDDED DISTRIBUTION TECHNOLOGY PRIVATE LIMITED seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">Sharing</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">Security Precautions</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">Data Deletion and Retention</h2>
              <p>
            ...
            <section>
              ...
              <p className="font-semibold">Subhadeep</p>
              <p className="mt-2">
                <strong>EMBEDDED DISTRIBUTION TECHNOLOGY PRIVATE LIMITED</strong><br />
                712, Corporate Avenue, A-Wing<br />
                Sonawala Road, Goregaon East<br />
                Mumbai, Maharashtra, India
              </p>
              <p className="mt-4">
                <strong>Contact Hours:</strong> Monday - Friday (9:00 - 18:00)
              </p>
            </section>
          </div>
        </div>
